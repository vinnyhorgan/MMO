...
namespace Server
{
    class AssetManager
    {
        ...
        {
            using (Stream stream = Assembly.GetExecutingAssembly().GetManifestResourceStream($"Server.Assets.Textures.{name}"))
            {
                if (stream == null)
                {
        ...
        {
            using (Stream stream = Assembly.GetExecutingAssembly().GetManifestResourceStream($"Server.Assets.Fonts.{name}"))
            {
                if (stream == null)
                {
